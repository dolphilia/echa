/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 889beb1ea27d6168585bf74f04c48ff2)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	ROOM_THUMBNAILS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	APP_ENV: "preview" | "production" | "local";
	PUBLIC_APP_ORIGIN: "https://preview.koge.app" | "https://koge.app" | "http://localhost:3000";
	PUBLIC_REALTIME_ORIGIN: "https://realtime-preview.koge.app" | "https://realtime.koge.app" | "http://localhost:8787";
	BETTER_AUTH_URL: "https://preview.koge.app" | "https://koge.app" | "http://localhost:3000";
	BETTER_AUTH_TRUSTED_ORIGINS: "https://preview.koge.app" | "https://koge.app" | "http://localhost:3000";
	CF_ACCESS_ISSUER: "https://dolphilia.cloudflareaccess.com";
	CF_ACCESS_AUD: "b7536e7cc03d57d8889760015ad850b72f08ae4a838a741054fc02094377c785" | "ddfcf25a51f780af02c6cff5073c6ba1fd0a6d42fdd9883a0232076cf5bd29ef";
	MODERATION_EVIDENCE_RETENTION_DAYS: 30;
	THUMBNAIL_ENABLED: "true";
	BETTER_AUTH_SECRET: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	REALTIME: Service /* entrypoint RoomProvisioningService from koge-realtime-preview */ | Service /* entrypoint RoomProvisioningService from koge-realtime */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "preview";
		PUBLIC_APP_ORIGIN: "https://preview.koge.app";
		PUBLIC_REALTIME_ORIGIN: "https://realtime-preview.koge.app";
		BETTER_AUTH_URL: "https://preview.koge.app";
		BETTER_AUTH_TRUSTED_ORIGINS: "https://preview.koge.app";
		CF_ACCESS_ISSUER: "https://dolphilia.cloudflareaccess.com";
		CF_ACCESS_AUD: "b7536e7cc03d57d8889760015ad850b72f08ae4a838a741054fc02094377c785";
		MODERATION_EVIDENCE_RETENTION_DAYS: 30;
		THUMBNAIL_ENABLED: "true";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		REALTIME: Service /* entrypoint RoomProvisioningService from koge-realtime-preview */;
	}
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		PUBLIC_APP_ORIGIN: "https://koge.app";
		PUBLIC_REALTIME_ORIGIN: "https://realtime.koge.app";
		BETTER_AUTH_URL: "https://koge.app";
		BETTER_AUTH_TRUSTED_ORIGINS: "https://koge.app";
		CF_ACCESS_ISSUER: "https://dolphilia.cloudflareaccess.com";
		CF_ACCESS_AUD: "ddfcf25a51f780af02c6cff5073c6ba1fd0a6d42fdd9883a0232076cf5bd29ef";
		MODERATION_EVIDENCE_RETENTION_DAYS: 30;
		THUMBNAIL_ENABLED: "true";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		REALTIME: Service /* entrypoint RoomProvisioningService from koge-realtime */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_APP_ORIGIN" | "PUBLIC_REALTIME_ORIGIN" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "CF_ACCESS_ISSUER" | "CF_ACCESS_AUD" | "MODERATION_EVIDENCE_RETENTION_DAYS" | "THUMBNAIL_ENABLED" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
