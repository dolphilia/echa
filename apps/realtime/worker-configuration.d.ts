/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e2a3f8b1da64d54112b02baadd6d15b)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	RUNTIME_SNAPSHOTS: R2Bucket;
	ROOM_THUMBNAILS: R2Bucket;
	DB: D1Database;
	SNAPSHOT_QUEUE: Queue;
	ROOM_CLEANUP_QUEUE: Queue;
	ROOM_CLEANUP_DLQ: Queue;
	MODERATION_EVIDENCE_QUEUE: Queue;
	MODERATION_EVIDENCE_DLQ: Queue;
	APP_ENV: "preview" | "production" | "local";
	APP_ORIGIN: "https://preview.koge.app" | "https://koge.app" | "http://localhost:3000";
	AUTH_BASE_URL: "https://preview.koge.app" | "https://koge.app" | "http://localhost:3000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_ORIGIN" | "AUTH_BASE_URL" | "SNAPSHOT_AUTOMATION_MODE" | "SNAPSHOT_TRIGGER_EVENT_COUNT" | "SNAPSHOT_TRIGGER_PAYLOAD_BYTES" | "SNAPSHOT_MIN_EVENT_DELTA" | "SNAPSHOT_MIN_PAYLOAD_DELTA_BYTES" | "THUMBNAIL_ENABLED" | "THUMBNAIL_INITIAL_DELAY_MS">> {}
}
