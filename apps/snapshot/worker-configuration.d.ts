/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75e222870f66ae65aa618f2bd650db86)
...
interface __BaseEnv_Env {
	...
	DRAWING_ROOM: DurableObjectNamespace /* DrawingRoom from koge-realtime-preview */ | DurableObjectNamespace /* DrawingRoom from koge-realtime */;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		APP_ENV: "preview";
		THUMBNAIL_ENABLED: "true";
		DRAWING_ROOM: DurableObjectNamespace /* DrawingRoom from koge-realtime-preview */;
	}
	interface ProductionEnv {
		...
		APP_ENV: "production";
		THUMBNAIL_ENABLED: "true";
		DRAWING_ROOM: DurableObjectNamespace /* DrawingRoom from koge-realtime */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "THUMBNAIL_ENABLED">> {}
}
